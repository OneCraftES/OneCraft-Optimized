...
mmc_path = Path.home() / "curseforge/minecraft/Instances/OneCraft Optimized/"
...
new_version = input("Enter new version: OneCraft Optimized ")

title_screen_obj["main_menu"]["bottom_right"][0]["text"] = f"OneCraft Optimized {new_version}"
save_file(title_screen_path, title_screen_obj)

warning_file_obj = load_json(warning_path)
warning_file_obj["overrides"]["minecraft"]["+recommends"]["OneCraft Optimized"] = f">{new_version}"
